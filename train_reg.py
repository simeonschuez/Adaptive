...
import os
import pickle
from train_eval import eval_reg_model
from utils import to_var
from data_loader import get_reg_loader as get_loader
...
def main(args):
    ...
    for epoch in range(start_epoch, args.num_epochs + 1):
        ...
        cider = eval_reg_model(adaptive, vocab, eval_loader, ref_df)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=80) # on cluster setup, 60 each x 4 for Huckle server
